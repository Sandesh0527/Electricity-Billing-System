...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String atype, String meter) {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/electu.jpg"));
        ...
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("icon/iconi.png"));
        ...
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("icon/ikon.png"));
        ...
        ImageIcon icon3 = new ImageIcon(ClassLoader.getSystemResource("icon/iton.png"));
        ...
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("icon/ison.png"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("icon/imon.png"));
        ...
        ImageIcon icon6 = new ImageIcon(ClassLoader.getSystemResource("icon/iron.png"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("icon/ikon.png"));
        ...
        ImageIcon icon8 = new ImageIcon(ClassLoader.getSystemResource("icon/iron.png"));
        ...
        ImageIcon icon9 = new ImageIcon(ClassLoader.getSystemResource("icon/ivon.png"));
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("icon/itn.png"));
        ...
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("icon/itn.png"));
        ...
        ImageIcon icon12 = new ImageIcon(ClassLoader.getSystemResource("icon/closeit.png"));
